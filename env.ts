...
const BUNDLE_IDS = {
  development: 'com.udaychittala.satyacablenetwork.development',
  preview: 'com.udaychittala.satyacablenetwork.preview',
  production: 'com.udaychittala.satyacablenetwork',
} as const;
...
const SCHEMES = {
  development: 'satyaCable.development',
  preview: 'satyaCable.preview',
  production: 'satyaCable',
} as const;

const NAME = 'Satya Cable & Broadband';
